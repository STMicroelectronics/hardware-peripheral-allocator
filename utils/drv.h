...
/*Below usage is defined for viv gpu */
#define BO_USE_GPU_TILED_VIV       (1ull << 29)
#define BO_USE_GPU_TS_VIV          (1ull << 30)
#if (ANDROID_SDK_VERSION >= 29)
#define BO_USE_GPU_NO_CLEAR_VIV    (1ull << 32)
#else
#define BO_USE_GPU_NO_CLEAR_VIV    (1ull << 31)
#endif
