...
int convert_pix_format_to_viv_format(int format) {
    int drmFormat = 0;
    switch (format) {
        case HAL_PIXEL_FORMAT_RGBA_8888:
            drmFormat = FORMAT_RGBA8888;
            break;
        case HAL_PIXEL_FORMAT_RGBX_8888:
            drmFormat = FORMAT_RGBX8888;
            break;
        case HAL_PIXEL_FORMAT_BGRA_8888:
            drmFormat = FORMAT_BGRA8888;
            break;
        case HAL_PIXEL_FORMAT_RGB_888:
            drmFormat = FORMAT_RGB888;
            break;
        case HAL_PIXEL_FORMAT_RGB_565:
            drmFormat = FORMAT_RGB565;
            break;
        case HAL_PIXEL_FORMAT_YV12:
            drmFormat = FORMAT_YV12;
            break;
        case HAL_PIXEL_FORMAT_YCbCr_422_SP:
            drmFormat = FORMAT_NV16;
            break;
        case HAL_PIXEL_FORMAT_YCrCb_420_SP:
            drmFormat = FORMAT_NV21;
            break;
        case HAL_PIXEL_FORMAT_YCbCr_422_I:
            drmFormat = FORMAT_YUYV;
            break;
        case HAL_PIXEL_FORMAT_YCbCr_420_P:
            drmFormat = FORMAT_I420;
            break;
        case HAL_PIXEL_FORMAT_YCbCr_420_SP:
            drmFormat = FORMAT_NV12;
            break;
        case HAL_PIXEL_FORMAT_YCbCr_420_888:
            drmFormat = FORMAT_NV12;
            break;
        case HAL_PIXEL_FORMAT_BLOB:
            drmFormat = FORMAT_BLOB;
            break;
        case HAL_PIXEL_FORMAT_NV12_TILED:
            drmFormat = FORMAT_NV12_TILED;
            break;
        case HAL_PIXEL_FORMAT_NV12_G1_TILED:
            drmFormat = FORMAT_NV12_G1_TILED;
            break;
        case HAL_PIXEL_FORMAT_NV12_G2_TILED:
            drmFormat = FORMAT_NV12_G2_TILED;
            break;
        case HAL_PIXEL_FORMAT_NV12_G2_TILED_COMPRESSED:
            drmFormat = FORMAT_NV12_G2_TILED_COMPRESSED;
            break;
        case HAL_PIXEL_FORMAT_YCBCR_P010:
            drmFormat = FORMAT_YCBCR_P010;
            break;
        case HAL_PIXEL_FORMAT_YCBCR_P210:
            drmFormat = FORMAT_YCBCR_P210;
            break;
        case HAL_PIXEL_FORMAT_P010:
            drmFormat = FORMAT_P010;
            break;
        case HAL_PIXEL_FORMAT_P010_TILED:
            drmFormat = FORMAT_P010_TILED;
            break;
        case HAL_PIXEL_FORMAT_P010_TILED_COMPRESSED:
            drmFormat = FORMAT_P010_TILED_COMPRESSED;
            break;
        case HAL_PIXEL_FORMAT_RGBA_1010102:
            drmFormat = FORMAT_RGBA1010102;
            break;
        case HAL_PIXEL_FORMAT_RGBA_FP16:
            drmFormat = FORMAT_RGBAFP16;
            break;
        case HAL_PIXEL_FORMAT_RAW16:
            drmFormat = FORMAT_RAW16;
            break;
